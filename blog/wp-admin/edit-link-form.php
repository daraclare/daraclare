...
<h4><label for="link_name"><?php _ex('Name', 'link name') ?></label></h4>
<div class="inside">
...
<h4><label for="link_url"><?php _e('Web Address') ?></label></h4>
<div class="inside">
...
<h4><label for="link_description"><?php _e('Description') ?></label></h4>
<div class="inside">
